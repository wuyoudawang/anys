...
// func (h http.Header) clone() http.Header {
...
// 		}
// 		c.setState(c.rwc, StateNew) // before Serve can return
// 		h.eng.NewJob(entity, name)
// 	}
// }

// func (h *HttpServer) BeforePendingJob(job *jobs.Job) error {
// 	return nil
// }

// func (h *HttpServer) AfterPendingJob(job *jobs.Job) error {
